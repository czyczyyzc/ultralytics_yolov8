...
ANTIUAV_SOURCE_ROOT="${ANTIUAV_SOURCE_ROOT:-/mnt/chenziye/datasets/anti_uav/Anti-UAV300}"
ANTIUAV_YOLO_ROOT="${ANTIUAV_YOLO_ROOT:-/mnt/chenziye/datasets/anti_uav/anti_uav300_yolo}"
EXTRA_YOLO_ROOT="${EXTRA_YOLO_ROOT:-/mnt/hanlue/hanlue_multirotor_assets_phase1_20260525}"
MERGED_YOLO_ROOT="${MERGED_YOLO_ROOT:-/mnt/chenziye/datasets/anti_uav/anti_uav300_plus_hanlue_yolo}"
